...
property[0] = "المساحة";
unit[0] = ["فدان", "آر", "هكتار", "سنتيمتر مربع", "قدم مربع", "بوصة مربعة", "كيلومتر مربع", "متر مربع", "ميل مربع", "ياردة مربعة", "قدم مربع"];
...
property[2] = "الكتلة (الوزن)";
unit[2] = ["طن", "كيلوغرام", "جرام", "ملليجرام", "طن (المملكة المتحدة)", "طن (الولايات المتحدة)", "قنطار (المملكة المتحدة)", "قنطار (الولايات المتحدة)", "ربع (المملكة المتحدة)", "ربع (الولايات المتحدة)", "سلاج", "حجر", "جنيه", "جنيه طروادة", "أوقية", "أوقية طروادة", "روبي", "درام", "دراخمة", "نقطة", "حبة"];
...
defaultUnits[2] = ["كيلوغرام", "جنيه"];

property[3] = "الضغط";
unit[3] = ["جو، أتموسفير","بار","ميليبار","كيلوجرام فورس/متر مربع","كيلوجرام فورس/سم مربع","كيلوباسكال","ميجاباسكال","باسكال","رطل فورس/قدم مربع","رطل فورس/بوصة مربعة","تور","كيلوباسكال","باسكال","ملليمتر من الزئبق [0 درجة مئوية]","أتموسفير [قياسي]","أتموسفير تقني [فيزيائي]","عمود مياه [متر]","كيلوجرام فورس/متر مربع","دين/سم مربع","جرام فورس/سم مربع","كيلوجرام فورس/سم مربع","كيلوجرام فورس/ملليمتر مربع","كيلوبوند/متر مربع","مليبار","نيوتن/متر مربع","أونصة/بوصة مربعة","رطل/قدم مربع","رطل/بوصة مربعة","بوندال/قدم مربع","أتموسفير تقني","طن/متر مربع","عمود مياه [سنتيمتر]","عمود مياه [بوصة]","عمود مياه [ملليمتر]"];
...
defaultUnits[3] = ["رطل فورس/بوصة مربعة", "كيلوباسكال [kPa]"];
...
property[5] = "الحجم والسعة";
unit[5] = ["متر مكعب", "لتر", "ليتر", "سنتيلتر", "ميليلتر", "سي سي", "سنتيمتر مكعب", "ميكروليتر", "كوب [متري]", "ملعقة طعام [مترية]", "ملعقة شاي [مترية]", "برميل", "دلو", "برميل [بريطاني]", "دلو [بريطاني]", "بوشل [بريطاني]", "قدم مكعب", "بوصة مكعبة", "ميل مكعب", "كوب", "درام", "خمسة", "جالون [سائل]", "جالون [بريطاني]", "جيل [أمريكي]", "جيل [بريطاني]", "مينيم", "أونصة", "أونصة [بريطاني, سائلة]", "بيك [بريطاني]", "بيك [أمريكي]", "باينت", "باينت [بريطاني]", "كوارت", "روبي", "طلقة", "ملعقة طعام", "ملعقة شاي", "ملعقة طعام [بريطاني]", "ملعقة شاي [بريطاني]"];
...
defaultUnits[5] = ["لتر", "أونصة"];

property[6] = "التسارع";
unit[6] = ["متر في الثانية المربعة", "قدم في الثانية المربعة", "جاذبية (تسارع)", "غاليليو", "بوصة في الثانية المربعة"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["متر في الثانية المربعة", "قدم في الثانية المربعة"];

property[7] = "السعة";
unit[7] = ["فاراد [ف]","ملي فاراد [مللي ف]","ميكروفاراد [ميكرو ف]","مانوفاراد [نانو ف]","بيكوفاراد [بيكو ف]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["ميكروفاراد [ميكرو ف]", "نانوفاراد [نانو ف]"];

property[8] = "الكثافة والقدرة الكتلية";
unit[8] = ["جرام لكل سنتيمتر مكعب","جرام لكل لتر","جرام لكل ميليلتر","كيلوجرام لكل لتر","كيلوجرام لكل متر مكعب","طن لكل متر مكعب","مليجرام لكل لتر","مليجرام لكل ميليلتر","أونصة لكل بوصة مكعبة","أونصة لكل جالون [المملكة المتحدة]","أونصة لكل جالون [الولايات المتحدة]","باوند لكل بوصة مكعبة","باوند لكل جالون [المملكة المتحدة]","باوند لكل جالون [الولايات المتحدة]"];
...
defaultUnits[8] = ["كيلوجرام لكل متر مكعب","باوند لكل جالون [الولايات المتحدة]"];

property[9] = "الشحنة الكهربائية";
unit[9] = ["كولومب [كولومب]","أبكولومب","ساعة أمبير [س.أمبير]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["كولومب [كولومب]","ساعة أمبير [س.أمبير]"];

property[10] = "الطاقة";
unit[10] = ["بي تي يو", "السعرات الحرارية (التغذية)", "السعرات الحرارية (الحرارة الكيميائية)", "جالون (أمريكي) من الغاز البترولي المسال", "ساعة الحصان", "جول", "كيلوغرام قوة متر", "كيلووات ساعة", "طن (متفجرات)", "وات ساعة"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["جول", "كيلووات ساعة"];

property[11] = "القوة";
unit[11] = ["نيوتن (ن)", "دين (دي)", "قوة الكيلوغرام (كغف)", "كيلوبوند (كب)", "كيب (ك)", "أونصة القوة (أونصة)", "جنيه القوة (جب)", "باوندل (بد)"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["قوة الكيلوغرام (كغف)", "نيوتن (ن)"];

property[12] = "القوة / الطول";
unit[12] = ["نيوتن لكل متر (ن/م)", "باوند قوة لكل بوصة (جبف/بوصة)", "باوند قوة لكل قدم (جبف/قدم)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["نيوتن لكل متر (ن/م)", "باوند قوة لكل بوصة (جبف/بوصة)"];

property[13] = "الإضاءة";
unit[13] = ["لومن/متر مربع (لو/م²)", "لومن/سم مربع (لو/سم²)", "لومن/قدم مربع (لو/قدم²)", "قدم الشموع (قدم-سدل)", "قدم لامبيرت (قدم-لامبيرت)", "كانديلا/متر مربع (كا/م²)", "كانديلا/سم مربع (كا/سم²)", "لوكس (لكس)", "نوكس (نكس)", "فوت (فوت)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["لومن/متر مربع (لو/م²)", "لومن/قدم مربع (لو/قدم²)"];

property[14] = "تدفق الكتلة";
unit[14] = ["كيلوغرام في الثانية (كغ/ث)", "جنيه كتلة في الثانية (جنيه/ث)", "جنيه كتلة في الدقيقة (جنيه/دقيقة)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["كيلوغرام في الثانية (كغ/ث)", "جنيه كتلة في الثانية (جنيه/ث)"];

property[15] = "الطاقة";
unit[15] = ["واط في الساعة (واط/ساعة)", "سعرة في الساعة (سعرة/ساعة)", "جيجاواط (جيجاواط)", "حصان كهربائي (حصان كهربائي)", "حصان دولي (حصان دولي)", "حصان متري (حصان متري)", "حصان مائي (حصان مائي)", "سعرة حرارية في الساعة (سعرة حرارية/ساعة)", "كيلوواط (كيلوواط)", "ميجاواط (ميجاواط)", "ميكروواط (ميكروواط)", "ميليواط (ميليواط)", "طن تبريد (طن تبريد)", "واط (واط)"];
...
defaultUnits[15] = ["حصان كهربائي (حصان كهربائي)", "واط (واط)"];

property[16] = "عزم الدوران";
unit[16] = ["نيوتن متر (ن.م)", "دين سنتيمتر (دين.سم)", "كيلوجرام قوة متري (كجم ق.م)", "جنيه-قدم (جنيه-قدم)", "جنيه-قدم (جنيه-قدم)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["نيوتن متر (ن.م)", "كيلوجرام قوة متري (كجم ق.م)"];

property[17] = "الزمن";
unit[17] = ["الثانية (ثانية)", "يوم (متوسط شمسي)", "يوم (نجمي)", "ساعة (متوسط شمسي)", "ساعة (نجمية)", "دقيقة (متوسط شمسي)", "دقيقة (نجمية)", "شهر (متوسط تقويمي)", "الثانية (نجمية)", "عام (تقويمي)", "عام (استوائي)", "عام (نجمي)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["يوم (متوسط شمسي)", "الثانية (ثانية)"];

property[18] = "السرعة والسرعة";
unit[18] = ["كيلومتر في الثانية", "كيلومتر في الساعة", "سنتيمتر في الثانية", "متر في الثانية", "متر في الدقيقة", "قدم في الثانية", "قدم في الدقيقة", "قدم في الساعة", "ميل في الساعة", "ميل في الثانية", "ميل بحري في الساعة", "ياردة في الثانية", "عقدة", "ماخ", "سرعة الضوء [جو]", "سرعة الضوء [فراغ]", "سرعة الصوت [جو]"];
...
defaultUnits[18] = ["كيلومتر في الساعة", "ميل في الساعة"];

property[19] = "لزوجة";
unit[19] = ["نيوتن-ثانية للمتر", "سنتيبويز", "سنتي ستوك", "قدم مربع في الثانية", "بويز", "باوندال-ثانية للقدم المربع", "جنيه للقدم في الثانية", "باوند فورس-ثانية للقدم المربع", "ريه", "سلاج للقدم في الثانية", "ستوك"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["نيوتن-ثانية للمتر", "باوندال-ثانية للقدم المربع"];

property[20] = "تدفق الحجم";
unit[20] = ["برميل في الدقيقة [المملكة المتحدة]", "برميل في الدقيقة [الولايات المتحدة]", "سنتيمتر مكعب في الثانية", "قدم مكعب في الثانية", "متر مكعب في الثانية", "مليمتر مكعب في الثانية", "جالون في الثانية [المملكة المتحدة]", "جالون في الثانية [الولايات المتحدة]", "لتر في الثانية", "ميليلتر في الثانية"];
...
defaultUnits[20] = ["قدم مكعب في الدقيقة", "متر مكعب في الثانية"];

property[21] = "زاوية";
unit[21] = ["درجة", "غراد", "راديان", "1/10 دائرة", "1/16 دائرة", "1/2 دائرة", "1/4 دائرة", "1/6 دائرة", "1/8 دائرة", "دقيقة قوسية", "درجة ثنائية", "راديان ثنائي", "دورة", "زاوية كاملة", "غراديان [غراد]", "ميل", "دقيقة زاوية مللي", "جزء من ثانية قوسية", "دقيقة", "قسم", "نقطة", "ربع دائرة", "زاوية قائمة", "ثانية", "سدس دائرة", "علامة", "زاوية مستقيمة"];
...
function clearResults() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>الرجاء، اختيار كمية فزيائية، وحدتين، ثم أدخل قيمة في أحد الصناديق أعلاه.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if (q == 0) { return ""; } // Unable to calculate the 'factor'

	var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat removes trailing zeros.
	// 14 is the length of the number returned by the PHP function in the xxxxx-unit-process.php file
	var factorTxt = conversionFactorTxt(factor, 1E-8);
	var inv = 1 / factor;
	var invFact = roundDec(inv, 12);

	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // Check if it's an integer // invFact can be zero if the 'factor' is too large ( > 10^12)
		ret += "<p><span class='destacado'>الصيغة:</span> قسّم القيمة في " + pluralForConverters(from, 2) + " على " + invFact + " لأن 1 " + to + " يساوي " + invFact + " " + pluralForConverters(from, 2) + ".</p>";
		ret += "<p>لذلك، " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" أو <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
	} else {
		ret = "<p><span class='destacado'>الصيغة:</span> ضرب القيمة في " + pluralForConverters(from, 2) + " بمعامل التحويل '" + factorTxt + "'.</p>";
		ret += "<p>لذلك، " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" أو <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
	}
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "الرجاء اختيار وحدتين مختلفتين.";
  }

  var how = "<h3>كيفية تحويل " + val + " " + from + " إلى " + to + "؟</h3>";
  how += "<p>لتحويل " + from + " إلى " + to + "، استخدم الصيغة:</p><p><span class=\"formula\">" + temperatureFormula(tuple) + "</span></p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>بالتالي، عند ضرب القيمة '" + val + "' في " + from + " بـ 9، ثم قسم الناتج على 5 ثم أضف 32، نحصل على:</p><p>";
    ...
    how += "<p>بالتالي، عند إضافة 273.15 إلى القيمة '" + val + "' في " + from + "، نحصل على:</p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>بالتالي، عند طرح 273.15 من القيمة '" + val + "' في " + from + "، نحصل على:</p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>بالتالي، عند ضرب القيمة '" + val + "' في " + from + " بـ 9، ثم قسم الناتج على 5 وطرح -459.67، نحصل على:</p><p>";
    ...
    how += "<p>بالتالي، عند طرح 32 من القيمة '" + val + "' في " + from + "، ثم ضرب الناتج في 5، ومن ثم قسم الناتج على 9، نحصل على:</p><p>";
    ...
    how += "<p>بالتالي، عند إضافة 459.67 إلى القيمة '" + val + "' في " + from + "، ثم ضرب الناتج في 5 ومن ثم القسمة على 9، نحصل على:</p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " ككسر قابل للاستخدام أو عدد صحيح في " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>هذه قيم بديلة لـ " + qTxt + " " + pluralForConverters(from, q) + " في " + pluralForConverters(to) + ". تمثل على شكل كسر أو عدد صحيح قريب من القيمة الدقيقة (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> إلخ). الخطأ التقريبي، إذا كان موجودًا، يظهر على اليمين من القيمة.</p>";
