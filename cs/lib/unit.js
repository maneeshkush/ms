...
property[0] = "Plocha";
unit[0] = ["akr", "ár", "hektar", "čtvereční centimetr", "čtvereční stopa", "čtvereční palec", "čtvereční kilometr", "čtvereční metr", "čtvereční míle", "čtvereční yard", "čtvereční stopy"];
...
defaultUnits[0] = ["akr", "čtvereční míle"];
...
property[2] = "Hmotnost (Váha)";
unit[2] = ["tuna","kilogram","gram","miligram","dlouhá tuna [UK]","krátká tuna [US]","sto liber [UK]","sto liber [US]","čtvrť [UK]","čtvrť [US]","slug","kámen","libra","troy libra","unce","troy unce","Robie","dram","drachma","bod","zrno"];
...
defaultUnits[2] = ["kilogram", "libra"];

property[3] = "Tlak";
unit[3] = ["atmosféra","bar","mbar","kgf/m2","kgf/cm2","kPa","MPa","Pa","lbf/ft2","psi","torr","ksi","kilopascal [kPa]","Pascal","milimetr rtuti [0 °C]","standardní atmosféra","technická atmosféra [at]","vodní sloupec [metr]","kilogram síly na čtvereční metr","dyne na čtvereční centimetr","gram síly na čtvereční centimetr","kilogram síly na čtvereční centimetr","kilogram síly na čtvereční milimetr","kilopond na čtvereční metr","milibar","newton na čtvereční metr","unce na čtvereční palec","libra na čtvereční stopu","libra na čtvereční palec","poundal na čtvereční stopu","technická atmosféra","tuna na čtvereční metr","vodní sloupec [centimetr]","vodní sloupec [palec]","vodní sloupec [milimetr]"];
...
defaultUnits[3] = ["libra na čtvereční palec", "kilopascal [kPa]"];
...
property[5] = "Objem a kapacita";
unit[5] = ["krychlový metr", "litr", "litr", "centilitr", "mililitr", "cc", "kubický centimetr", "mikrolitr", "hrnek [metrický]", "lžíce [metrická]", "čajová lžička [metrická]", "barel", "kbelík", "barel [UK]", "kbelík [UK]", "bušl [UK]", "krychlový stopa", "krychlový palec", "krychlová míle", "hrnek", "dram", "pětina", "galon [kapalný]", "galon [UK]", "gill [US]", "gill [UK]", "minim", "unce", "unce [UK, kapalná]", "pek [UK]", "pek [US]", "pinta", "pinta [UK]", "kvart", "Robie", "střela", "lžíce", "čajová lžička", "lžíce [UK]", "čajová lžička [UK]"];
...
defaultUnits[5] = ["litr", "unce"];

property[6] = "Zrychlení";
unit[6] = ["metr za sekundu na druhou", "stopa za sekundu na druhou", "gravitace (zrychlení)", "Galileo", "palec za sekundu na druhou"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["metr za sekundu na druhou", "stopa za sekundu na druhou"];

property[7] = "Kapacita";
unit[7] = ["Farad [F]","milifarad [mF]","mikrofarad [µF]","nanofarad [nF]","pikofarad [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["mikrofarad [µF]", "nanofarad [nF]"];

property[8] = "Hustota a hmotnostní kapacita";
unit[8] = ["gram na kubický centimetr","gram na litr","gram na mililitr","kilogram na litr","kilogram na kubický metr","tuna na kubický metr","miligram na litr","miligram na mililitr","unce na kubický palec","unce na galon [UK]","unce na galon [US]","libra na kubický palec","libra na galon [UK]","libra na galon [US]"];
...
defaultUnits[8] = ["kilogram na kubický metr","libra na galon [US]"];

property[9] = "Elektrický náboj";
unit[9] = ["Coulomb [C]", "abcoulomb", "Ampérová hodina [A.h]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampérová hodina [A.h]"];

property[10] = "Energie";
unit[10] = ["Btu","kalorie (výživová)","kalorie (termochemická)","galon (US) LPG","koňská síla-hodina","Joule","kilogram-síla metr","kilowatt-hodina","tuna (výbušnina)","watt-hodina"];
factor[10] = [1055.0559,4186.8,4.184,100757838.45,2684519.5,1,9.80665,3600000,4184000000,3600];
defaultUnits[10] = ["Joule","kilowatt-hodina"];

property[11] = "Síla";
unit[11] = ["Newton (N)", "Dýn (dy)", "Kilogram síly (kgf)", "Kilopond (kpf)", "Kip (k)", "Ounce síly (ozf)", "Libra síly (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogram síly (kgf)","Newton (N)"];

property[12] = "Síla / Délka";
unit[12] = ["Newton na metr (N/m)","libra síly na palec (lbf/in)","libra síly na stopu (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton na metr (N/m)", "libra síly na palec (lbf/in)"];

property[13] = "Oslnění";
unit[13] = ["lumen na metr čtvereční (lm/m²)","lumen na centimetr čtvereční (lm/cm²)","lumen na stopu čtvereční (lm/ft²)","svítil (ft-cdl)","stopový lambert","kandela na metr čtvereční (cd/m²)","kandela na centimetr čtvereční (cd/cm²)","lux (lx)","nox (nx)","phot (ph)"];
factor[13] = [1,10000,10.76391,10.76391,10.76391,3.141592505,31415.92505,1,-328716,10000];
defaultUnits[13] = ["lumen na metr čtvereční (lm/m²)","lumen na stopu čtvereční (lm/ft²)"];

property[14] = "Hmotnostní průtok";
unit[14] = ["kilogram za sekundu (kg/s)","librová hmotnost za sekundu (lbm/s)","librová hmotnost za minutu (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogram za sekundu (kg/s)", "librová hmotnost za sekundu (lbm/s)"];

property[15] = "Výkon";
unit[15] = ["Btu za hodinu","kalorie za hodinu","gigawatt","koně elektromotorické (hp)","koně mezinárodní (hp)","koně metrické (hp)","koně vodní (hp)","kilokalorie za hodinu","kilowatt","megawatt","mikrowatt","miliwatt","chladicí tuny","watt"];
...
defaultUnits[15] = ["koně elektromotorické (hp)","watt"];

property[16] = "Moment síly";
unit[16] = ["Newton-metr (N.m)", "dyn-centimetr (dy.cm)", "kgf-metr (kgf.m)", "lbf-palec (lbf.in)", "lbf-stopa (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metr (N.m)", "kgf-metr (kgf.m)"];

property[17] = "Čas";
unit[17] = ["Sekunda (sec)", "Den (střední sluneční)", "Den (hvězdný)", "Hodina (střední sluneční)", "Hodina (hvězdná)", "Minuta (střední sluneční)", "Minuta (hvězdná)", "Měsíc (kalendářní)", "Sekunda (hvězdná)", "Rok (kalendářní)", "Rok (tropický)", "Rok (hvězdný)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Den (střední sluneční)", "Sekunda (sec)"];

property[18] = "Rychlost a Rychlost";
unit[18] = ["kilometr za sekundu", "kilometr za hodinu", "centimetr za sekundu", "metr za sekundu", "metr za minutu", "stopa za sekundu", "stopa za minutu", "stopa za hodinu", "míle za hodinu", "míle za sekundu", "námořní míle za hodinu", "yard za sekundu", "uzel", "mach", "rychlost světla [vzduch]", "rychlost světla [vakuum]", "rychlost zvuku [vzduch]"];
...
defaultUnits[18] = ["kilometr za hodinu", "míle za hodinu"];

property[19] = "Viskozita";
unit[19] = ["Newton-sekunda za metr", "centipoise", "centistoke", "čtvereční stopa za sekundu", "Poise", "poundal-sekunda za čtvereční stopu", "librahmotnost na stopu-sekundu", "libra síla-sekunda za čtvereční stopu", "rhe", "slug za stopu-sekundu", "stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-sekunda za metr", "poundal-sekunda za čtvereční stopu"];

property[20] = "Objemový průtok";
unit[20] = ["barel za minutu [UK]","barel za minutu [US]","kubický centimetr za sekundu","kubický stopa za sekundu","kubický metr za sekundu","kubický milimetr za sekundu","galon za sekundu [UK]","galon za sekundu [US]","litr za sekundu","mililitr za sekundu"];
...
defaultUnits[20] = ["kubický stopa za minutu","kubický metr za sekundu"];

property[21] = "Úhel";
unit[21] = ["stupeň","grad","radián","1/10 kruhu","1/16 kruhu","1/2 kruhu","1/4 kruhu","1/6 kruhu","1/8 kruhu","minuta oblouku","binární stupeň","binární radián","cyklus","plný úhel","gradián [grad]","mil","milliarcminuta","milisekunda oblouku","minuta","osmina kruhu","bod","čtvrt kruhu","pravý úhel","sekunda","šestnáctina kruhu","znaménko","přímý úhel"];
...
function clearResults() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>Prosím, vyberte fyzikální veličinu, dvě jednotky a poté zadejte hodnotu do kteréhokoli z polí výše.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    var ret = "";
    if (q == 0) { return ""; } // nemůže vypočítat 'faktor'

    var factor = parseFloat((converted / q).toPrecision(14)); //parseFloat odstraní nuly vpravo.
    // 14 je délka čísla vráceného funkcí v souboru xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // ověřuje, zda je to celé číslo
        ret += "<p><span class='destacado'>Vzorec:</span> podělte hodnotu v " + pluralForConverters(from, 2) + " číslem " + invFact + " protože 1 " + to + " je rovno " + invFact + " " + pluralForConverters(from, 2) + ".</p>";
        ret += "<p>Takže " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" nebo <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
    } else {
        ret = "<p><span class='destacado'>Vzorec:</span> vynásobte hodnotu v " + pluralForConverters(from, 2) + " konverzním faktorem '" + factorTxt + "'.</p>";
        ret += "<p>Takže " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" nebo <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
    }
...
function explainTemperature(val, from, to) {
    ...
    if (from === to) {
        return "Prosím, vyberte dvě různé jednotky.";
    }

    var how = "<h3>Jak převést " + val + " " + from + " na " + to + "?<\/h3>";
    how += "<p>Pro převod z " + from + " na " + to + " použijte vzorec: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

    if (tuple === "Celsius_Fahrenheit") {
        //"Celsius Fahrenheit":q*9/5+32,
        how += "<p>Tedy násobením hodnoty '" + val + "' v " + from + " devíti, dělením výsledku pěti a přičtením 32, získáte:<\/p><p>";
        ...
        how += "<p>Tedy přičtením 273.15 k hodnotě '" + val + "' v " + from + " získáte<\/p><p>";
        how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
    } else if (tuple === "Kelvin_Celsius") {
        //"Kelvin Celsius":q-273.15,
        how += "<p>Tedy odečtením 273.15 od hodnoty '" + val + "' v " + from + " získáte<\/p><p>";
        how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
    } else if (tuple === "Kelvin_Fahrenheit") {
        //"Kelvin Fahrenheit":q*9/5-459.67,
        how += "<p>Tedy násobením hodnoty '" + val + "' v " + from + " devíti, dělením výsledku pěti a odečtením -459.67, získáte<\/p><p>";
        ...
        how += "<p>Tedy odečtením 32 od hodnoty '" + val + "' v " + from + ", násobením výsledku pěti a dělením výsledku devíti, získáte<\/p><p>";
        ...
        how += "<p>Tedy přičtením 459.67 k hodnotě '" + val + "' v " + from + ", násobením výsledku pěti a dělením výsledku devíti, získáte<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " jako použitelný zlomek nebo celé číslo v " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Toto jsou alternativní hodnoty pro " + qTxt + " " + pluralForConverters(from, q) + " v " + pluralForConverters(to) + ". Jsou vyjádřeny jako zlomek nebo celé číslo blízko přesné hodnotě (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span 'top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> atd.). Případná chyba aproximace je uvedena vpravo od hodnoty.</p>";
